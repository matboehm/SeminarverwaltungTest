...
function onChangeEvent() {
	...
	xhr.open("POST", "system/modules/seminarverwaltung/classes/seminardaten.php", true);
	...
	xhr.send("seminaridx=" + seminaridx);
}
...
function onChangeEventCat() {
	// Voraussetzungen prüfen
	xhr.open("POST", "system/modules/seminarverwaltung/classes/seminarselect.php", true);
